...
contract ERC20 is IERC20 {
    ...
    function transfer(address receipient, uint amount) external override returns(bool) {
    ...
    function transferFrom(address sender, address receipient, uint amount) external override returns(bool) {
